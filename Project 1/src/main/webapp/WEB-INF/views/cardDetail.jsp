...
<div class="content">
        ...
        <form:form action="${pageContext.request.contextPath}/cardDetail/${order.cart.cartId}" method="post" id="paymentForm"
                   ...
                   <div class="span9 center margin-bottom"> 
					...
					<div class="span4">
					  ...
					  <label class="control-label">Card Number</label>
						...
						<form:input path="cardNumber" id="name" class="form-Control" maxlength="16"/>
						</div>
						</div>
						<div class="control-group">
					  <label class="control-label">Expiry Date</label>
						...
						<div class="form-group" class="controls docs-input-sizes">
						<form:errors path="cvNumber" cssStyle="color: #ff0000"/>
						<form:password path="cvNumber" id="cvnumber" maxlength="3" class="form-Control"/>
						</div>
						</div>
						<div class="control-group">
					  ...
					  <label class="control-label">ATM Pin</label>
						...
						<form:password path="atmPin" id="pin" maxlength="4" class="form-Control"/>
						</div>
						</div>
						<div class="control-group">
					...
					<div class="span2 no_margin_left">
					  <input type="submit" value="Pay Now" class="btn btn-primary pull-left">
					 	...
					 	<a href="<c:url value="/" />" class="btn btn-danger pull-right">Cancel</a>
					    </div>
				</div>
