...
<div class="span9 margin-left10" ng-app="addToCartApp">
	 ...
	 <div class="row margin-left25" ng-controller = "addToCartCtrl" ng-init="retrieveCart('${cartId}')">
        <table class="table table-bordered table-striped fs13" >
		  <thead>
			...
			<tbody>
				<tr ng-repeat = "items in cart.cartItems">
					 	<td class="span1"><img class="grow" src="<c:url value="/resources/img/{{items.itemId}}.jpg" /> " alt="image"/></td>
						<td>{{items.name}}</td>
						<td>{{items.price}}</td>
          ...
          <div class="row">
		  <div class="span3">
             <a href="<spring:url value="/Product" />" class="btn btn-primary center">Continue Shopping</a>
			</div>	
			<div class="span3">
